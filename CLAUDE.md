...
contract. 1023 tests pass; the public API is fully XML-documented and `GenerateDocumentationFile` is on,
...
tested. Stages M0 through M5 are done: nothing hand-written survives, and `Api/PublicSurfaceTests`
