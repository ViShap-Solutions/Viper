...
| [Development-Workflow.md](Development-Workflow.md) | How work moves through the repository: branches, tags, the alpha/beta/rc/stable cycle, SemVer rules, fixture freezing, benchmark baselines, hotfixes. Written in Russian. | Current |
| [rework/](rework) | The pre-release rework: the plan, its change files for the contract, QA and benchmark plans, and the owner's decision record. | Approved — R0 not started |
